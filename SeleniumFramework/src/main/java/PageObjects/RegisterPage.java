...
public class RegisterPage extends BasePage{
    ...
    private By RejectionRegisterMessageLocator = By.xpath("//div[@class='alert alert-danger alert-dismissible']");
    ...
    public String GetRejectionMessage(){
        return driver.findElement(RejectionRegisterMessageLocator).getText();
    }
